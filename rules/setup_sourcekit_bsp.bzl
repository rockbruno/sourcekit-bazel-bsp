...
setup_sourcekit_bsp = rule(
    ...
    attrs = {
        ...
        "targets": attr.label_list(
            doc = "The *top level* Bazel applications or test targets that this should serve a BSP for. If not specified, the server will try to discover top-level targets automatically",
            mandatory = True,
        ),
